...
<aside className="fixed left-0 top-0 h-screen w-64 bg-slate-50 dark:bg-slate-900 flex flex-col py-8 px-6 z-50">
<div className="mb-10 px-2">
<h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-50">InternBeacon</h1>
<p className="text-xs text-on-primary-container/70 font-medium">Curated Excellence</p>
</div>
<nav className="flex-1 space-y-1">
<a className="flex items-center gap-3 px-4 py-3 font-plus-jakarta text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-colors rounded-lg" href="#">
...
{/* Active Navigation Logic: Settings (nearest to User Management) */}
<a className="flex items-center gap-3 px-4 py-3 font-plus-jakarta text-sm font-bold text-slate-900 dark:text-slate-50 border-r-4 border-amber-500 bg-slate-200/30" href="#">
<span className="material-symbols-outlined">settings</span>
                Settings
            </a>
</nav>
<div className="mt-auto pt-6 space-y-1">
<button className="w-full bg-primary-container text-white py-3 rounded-lg font-semibold text-sm mb-6 active:scale-95 transition-transform">
                Post a Role
            </button>
<a className="flex items-center gap-3 px-4 py-2 font-plus-jakarta text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200" href="#">
...
<header className="sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl flex justify-between items-center w-full h-16 px-8 shadow-sm shadow-slate-200/50">
...
<input className="bg-transparent border-none focus:ring-0 text-sm w-full font-body placeholder:text-slate-400" placeholder="Search system resources..." type="text"/>
</div>
<div className="flex items-center gap-6">
<button className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50 relative">
<span className="material-symbols-outlined">notifications</span>
<span className="absolute top-0 right-0 w-2 h-2 bg-amber-500 rounded-full border-2 border-white"></span>
</button>
<button className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50">
