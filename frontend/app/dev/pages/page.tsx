...
const ROUTES: { path: string; label: string }[] = [
  ...
  { path: "/dashboard/resume", label: "Student Resume Optimizer" },
  { path: "/dashboard/recommendations", label: "Student AI Recommendations" },
  { path: "/dashboard/notifications", label: "Student Notifications" },
  { path: "/admin/dashboard", label: "Admin Platform Overview" },
  ...
  { path: "/employer/profile", label: "Employer Company Profile" },
  { path: "/employer/matches", label: "Employer Candidate Matches" },
