...
<aside className="fixed left-0 top-0 h-screen w-64 border-r-0 flex flex-col py-8 px-6 bg-slate-50 dark:bg-slate-900 z-50">
<div className="mb-12">
<h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-50">InternBeacon</h1>
<p className="text-[10px] uppercase tracking-widest text-on-primary-container mt-1">Curated Excellence</p>
</div>
<nav className="flex-1 space-y-2">
<a className="flex items-center gap-3 py-3 px-4 rounded-xl transition-all hover:bg-slate-200/50 dark:hover:bg-slate-800/50 text-slate-500 dark:text-slate-400" href="#">
<span className="material-symbols-outlined">dashboard</span>
<span className="font-medium text-sm">Dashboard</span>
</a>
<a className="flex items-center gap-3 py-3 px-4 rounded-xl transition-all text-slate-900 dark:text-slate-50 font-bold border-r-4 border-amber-500 bg-slate-200/30" href="#">
<span className="material-symbols-outlined">description</span>
<span className="font-medium text-sm">Applications</span>
</a>
<a className="flex items-center gap-3 py-3 px-4 rounded-xl transition-all hover:bg-slate-200/50 dark:hover:bg-slate-800/50 text-slate-500 dark:text-slate-400" href="#">
<span className="material-symbols-outlined">group</span>
<span className="font-medium text-sm">Talent Pool</span>
</a>
<a className="flex items-center gap-3 py-3 px-4 rounded-xl transition-all hover:bg-slate-200/50 dark:hover:bg-slate-800/50 text-slate-500 dark:text-slate-400" href="#">
...
<div className="mt-auto pt-8 border-t border-slate-200/50 space-y-2">
<button className="w-full bg-primary-container text-white py-3 rounded-xl font-semibold text-sm hover:opacity-90 active:scale-95 transition-all mb-4">
                Post a Role
            </button>
<a className="flex items-center gap-3 py-2 px-4 text-slate-500 text-sm hover:text-slate-900 transition-colors" href="#">
...
<header className="fixed top-0 right-0 z-40 flex justify-between items-center h-16 px-8 ml-64 max-w-[calc(100%-16rem)] w-full bg-white/80 backdrop-blur-xl shadow-sm shadow-slate-200/50">
<div className="flex items-center bg-surface-container-low px-4 py-2 rounded-full w-96 group focus-within:ring-2 ring-slate-900/10">
<span className="material-symbols-outlined text-slate-400 text-lg">search</span>
<input className="bg-transparent border-none focus:ring-0 text-sm w-full placeholder:text-slate-400" placeholder="Search candidate matches..." type="text"/>
</div>
...
<img alt="User avatar" className="h-full w-full object-cover" data-alt="Professional portrait of a corporate recruiter in a modern office setting, soft daylight" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDVjUZOpVs4pGbtNIAmxzZTrAv48cczPCR6y_lDj9T7zJJCXQCImrq4VvNBtrGcCL6h1bEHhdExoluHfZm5qxrBOyEaoi9dVCeNMir0fVC97h1PwyRsvDqqeX2v53C9dcY0_N8MGmN2bQ1Gql72LXiELXmRZo1N_PyQuu9N51V0ZpDLsehy5l7S6qIjZhHa6MAWdloTzZypLh_UnFUzeRIURMohHgZoki_zkA2zCu8ouomHVd2b271Ed6PmXEp3mqpWmERTPY3CFnM"/>
</div>
</div>
</header>
{/* Main Content Canvas */}
