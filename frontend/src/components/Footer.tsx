        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <div>
              ...
              <p className="text-slate-400 max-w-sm leading-relaxed">
                The bridge between Cameroon&apos;s top-tier academic talent and industry-leading companies.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <input
                  className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-secondary/50 placeholder:text-slate-500"
                  placeholder="Enter your email"
                  type="email"
                />
                <button className="px-6 py-3 bg-secondary-container text-on-secondary-fixed font-bold rounded-xl text-sm hover:opacity-90 transition-all">
                  Join
                </button>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <a className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors" href="#" aria-label="LinkedIn">
              ...
              <a className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors" href="#" aria-label="Twitter / X">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
              </a>
              <a className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors" href="#" aria-label="WhatsApp">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.438 9.889-9.886.002-5.443-4.435-9.885-9.881-9.885-5.446 0-9.884 4.438-9.887 9.886-.001 2.227.62 4.393 1.908 6.22l-1.006 3.674 3.771-.989-.186-.106z" /></svg>
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div className="space-y-6">
              <h4 className="text-sm font-bold uppercase tracking-widest font-headline text-white">Students</h4>
              <ul className="flex flex-col gap-4">
                ...
                <li><Link className="text-slate-400 hover:text-white transition-colors text-sm font-medium" href="/signup">Create account</Link></li>
                <li><Link className="text-slate-400 hover:text-white transition-colors text-sm font-medium" href="/login">Sign in</Link></li>
              </ul>
            </div>
            <div className="space-y-6">
              <h4 className="text-sm font-bold uppercase tracking-widest font-headline text-white">Employers</h4>
              <ul className="flex flex-col gap-4">
                <li><Link className="text-slate-400 hover:text-white transition-colors text-sm font-medium" href="/employers">Why InternBeacon</Link></li>
                ...
                <li><Link className="text-slate-400 hover:text-white transition-colors text-sm font-medium" href="/employer/dashboard">Employer console</Link></li>
              </ul>
            </div>
            <div className="space-y-6">
