...
export default function EditOffer() {
  ...
  if (isError || !offer) return <p className="text-white/40 text-sm">Offer not found.</p>;

  return (
    <div className="max-w-2xl space-y-5">
      <div>
        <h2 className="text-2xl font-black text-white">Edit Internship</h2>
        <p className="text-white/40 text-sm mt-0.5">{offer.title}</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <FormSection title="Basic Information" icon={Briefcase}>
          ...
          <div className="space-y-1.5">
            ...
            <textarea rows={5} placeholder="Describe the internship role…"
